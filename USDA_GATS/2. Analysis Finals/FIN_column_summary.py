##              This script connects to the usda_gats_db MySQL database and performs a column summary on a specified                 ##
##                table's columns. It outputs data type, nulls, unique counts, and statistics for numeric columns.                   ##
##                                                                                                                                   ##
...
if __name__ == "__main__":
    ...
    print("------------------------------------------------------------------------------------------------------------------------------------")
    print(f"\n                      🚀 Running Column Health Summary for Table {table}:\n")
    run_column_summary(f"{table}")
    print("------------------------------------------------------------------------------------------------------------------------------------\n")